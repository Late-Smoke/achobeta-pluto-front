...
function __VLS_template() {
    ...
    // @ts-ignore
    const __VLS_1 = __VLS_asFunctionalComponent(__VLS_0, new __VLS_0({ ...{ class: ("common-layout") }, }));
    ...
    [ElAside, ElAside,];
    // @ts-ignore
    const __VLS_25 = __VLS_asFunctionalComponent(__VLS_24, new __VLS_24({ ...{ class: ("aside") }, width: ("200px"), }));
    const __VLS_26 = __VLS_25({ ...{ class: ("aside") }, width: ("200px"), }, ...__VLS_functionalComponentArgsRest(__VLS_25));
